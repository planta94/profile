...
*   **Main Portfolio (`/`)**: Hosts the primary developer profile ([PortfolioComponent](file:///c:/Users/chine/OneDrive/Desktop/Github/personal-website/src/app/portfolio/portfolio.component.ts)) showcasing interactive capability tabs, career experience, academic publications, and contact forms.
